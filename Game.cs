...
namespace WierdGameTry
{
    public class Game
    {
        public Game()
        {
            ...
            //Console.Clear();
            // heres where i instantuated the player Graphic
            playerUnit = new PlayerUnit(10, 5, "@");

            // drawing the enemys
            enemysUnit = new EnemyUnits(14, 9, "G");
        }
        
        private Units playerUnit;
        private Units enemysUnit;
        ...
        public void Run()
        {
            while (true)
                ...
                //how the fuck will i draw the map here???????????????????????????????????????????????????????
            ...
            //first update all units
                ...
                //Console.Clear();
                //actually drawing the units here!!!
                playerUnit.Draw();
                enemysUnit.Draw();
               // mapHandler.Draw();
        ...
        public class MapHandler
        {
            ...
            // public int MapHandler mapHandler;
